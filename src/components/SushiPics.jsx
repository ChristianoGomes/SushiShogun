...
const SushiPics = () => {
  return (
    ...
    <div class="container mx-auto px-[12px] md:px-24 xl:px-12 max-w-[1300px] ">
        <h1 class="text-center text-5xl pb-20">Our Specialties</h1>
        <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 gap-y-28 lg:gap-y-16">
            <div class="relative group h-48 flex   flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <a href="#" class="block">
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Automotive" title="Automotive" loading="lazy"
                ...
                <a href="#" class="block">
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi2}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Toys and Baby Products"
                ...
                <a href="#" class="block">
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi3}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Medical" title="Medical" loading="lazy" width="200"
                                height="200"/>
                        </div>
                    </div>
                    <div class="p-6   z-10 w-full   ">
                ...
                <a href="#" class="block">
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi4}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Glass" title="Glass" loading="lazy" width="200"
                                height="200"/>
                        </div>
                    </div>
                    <div class="p-6   z-10 w-full   ">
                ...
                <a href="#"
                    ...
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi5}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Jewelry Coins and Medallions"
                ...
                <a href="#"
                    ...
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi6}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Electric" title="Electric" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div class="p-6   z-10 w-full   ">
                ...
                <a href="#"
                    ...
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi7}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Packaging / FMCG" title="Packaging / FMCG"
                ...
                <a href="#"
                    ...
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi8}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Footwear" title="Footwear" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div class="p-6   z-10 w-full   ">
                ...
                <a href="#"
                    ...
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi10}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Caps and Closures" title="Caps and Closures"
                                loading="lazy" width="200" height="200"/>
                        </div>
                    </div>
                    <div class="p-6   z-10 w-full   ">
                ...
                <a href="@" class="block">
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi1}
                                class="w-36 h-36  mt-6 m-auto z-11" alt="Confectionery" title="Confectionery" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div class="p-6   z-10 w-full   ">
                ...
                <a href="#" class="block">
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-red-400 rounded-xl justify-items-center align-middle">
                            <img src={sushi12}
                                class="w-36 h-36  mt-6 m-auto z-9" alt="Cosmetics" title="Cosmetics" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div class="p-6   z-10 w-full   ">
